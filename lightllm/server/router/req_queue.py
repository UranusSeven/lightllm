...
class ReqQueue:
    def __init__(
        self, max_total_tokens, batch_max_tokens, running_max_req_size
    ) -> None:
    ...
    def _can_add_new_req(self, req):
        self.cache_len_list.append(
            (req.input_len + 1, req.max_output_len - 1)
        )  # hard to analysis
    ...
    def generate_new_batch(self, current_batch: Batch):
        if (
            ...
            and len(current_batch.reqs) >= self.running_max_req_size
        ):
            return None
